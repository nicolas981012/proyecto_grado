    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              <i class="glyphicon glyphicon-blackboard"></i> <span>DOCENTES</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href=agregar_docente.php><i class="fa fa-circle-o"></i> INGRESAR DOCENTE</a></li>
              <li><a href=docentes.php><i class="fa fa-circle-o"></i> VER LISTADO DOCENTES</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
              <i class="glyphicon glyphicon-education"></i> <span>ESTUDIANTES</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href=agregar_alumno.php><i class="fa fa-circle-o"></i> INGRESAR ESTUDIANTE</a></li>
              <li><a href=Alumnos.php><i class="fa fa-circle-o"></i> VER LISTADO ESTUDIANTES</a></li>
            </ul>
          </li>
        </ul>
        <!-- /.sidebar-menu -->
