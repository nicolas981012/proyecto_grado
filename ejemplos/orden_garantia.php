    ...
    <section class="content container-fluid">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">LISTA DE ORDENES EN GARANTIA</h3>
                ...
                <div style="overflow-x:auto;">
                    <table class="table table-striped" id="myProduct" data-order='[[ 3, "desc" ]]' data-page-length='25'>
                        ...
                        <tbody>
                            ...
                            AND (A.est_man = 1) order by A.fec_man DESC;");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="ver_orden.php?id=<?php echo $row->ID; ?>" class="btn btn-default btn-sm" title="VER ORDEN"><i class="fa fa-eye"></i></a>
                                        ...
                                        <a href="ver_historial.php?id=<?php echo $row->ID; ?>" target="_blank" class="btn btn-danger" title="VER HISTORIAL"><i class="glyphicon glyphicon-info-sign"></i></a>
                                        <a href="agregar_garantia.php?id=<?php echo $row->ID; ?>" class="btn btn-success" title="AÑADIR ORDEN A GARANTIA"><i class="glyphicon glyphicon-check"></i></a>
                                        <a href="misc/nota.php?id=<?php echo $row->ID; ?>" target="_blank" class="btn btn-primary" title="IMPRIMIR ORDEN"><i class="fa fa-print"></i></a>
                                        <a href="editar_orden.php?id=<?php echo $row->ID; ?>" class="btn btn-info btn-sm" title="EDITAR ORDEN"><i class="fa fa-pencil"></i> </a>
                                         <?php if ($_SESSION['role'] == "111100") { ?>
                                        <a href="eliminar_orden.php?id=<?php echo $row->ID; ?>" class="btn btn-danger btn-sm" title="##"><i class="fa fa-trash"></i></a>
