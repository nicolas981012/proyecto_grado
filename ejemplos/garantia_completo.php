                ...
                <div style="overflow-x:auto;">
                    <table class="table table-striped" id="myProduct" data-order='[[ 0, "desc" ]]' data-page-length='25'>
                        ...
                        <tbody>
                            ...
                            $date_past = strtotime('-180 day', strtotime($date_now));
                            ...
                            AND (b.est_equ_gar = 2 OR b.est_equ_gar=3 OR b.est_equ_gar=4 OR b.est_equ_gar=6 OR b.est_equ_gar=1) order by b.id_man_gar desc ");
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    <a href="eliminar_orden.php?id=<?php echo $row->ID; ?>"class="btn btn-danger btn-sm" title="CANCELAR GARANTIA"><i class="fa fa-trash" ></i></a>
