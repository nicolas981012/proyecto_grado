    ...
    <section class="content container-fluid">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">LISTA DE ORDENES CANCELADAS</h3>
            </div>
            <div class="box-body">
                <div style="overflow-x:auto;">
                    <table class="table table-striped" id="myProduct" data-order='[[ 3, "desc" ]]' data-page-length='25'>
                        ...
                        <tbody>
                            ...
                            AND (A.est_man = 8) order by A.fec_man DESC;");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="devolver_orden.php?id=<?php echo $row->ID; ?>" class="btn btn-success " title="DEVOLVER ORDEN A TRAMITE"><i class="glyphicon glyphicon-check"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
