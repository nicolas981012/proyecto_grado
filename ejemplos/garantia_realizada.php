                ...
                <div style="overflow-x:auto;">
                    <table class="table table-striped" id="myProduct" data-order='[[ 0, "desc" ]]' data-page-length='25'>
                        ...
                        <tbody>
                            ...
                            AND (b.est_equ_gar = 5 OR b.est_equ_gar=7 OR b.est_equ_gar=9 ) order by b.id_man_gar desc ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editar_garantia.php?id=<?php echo $row->ID; ?>" class="btn btn-info btn-sm"title="EDITAR GARANTIA"><i class="fa fa-pencil" ></i><span>EDITAR</span></a>
                                        <a href="ver_garantia.php?id=<?php echo $row->ID; ?>" class="btn btn-default btn-sm"title="VER GARANTIA"><i class="fa fa-eye" ></i><span>VER GARANTIA</span></a>
                                         <?php if ($_SESSION['role'] == "111100") { ?>
                                            <a href="eliminar_orden.php?id=<?php echo $row->ID; ?>" class="btn btn-danger btn-sm" title="CANCELAR GARANTIA"><i class="fa fa-trash"></i><span>ELIMINAR</span></a>
