                ...
                <div style="overflow-x:auto;">
                    <table class="table table-striped" id="myProduct">
                        ...
                        <tbody>
                            ...
                            $select = $pdo->prepare("SELECT b.idContenido as ID,b.titulo as titulo ,b.estado as estado,a.Nombre as nombre
                            FROM clase a
                            join contenido b
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['role'] == "docente") { ?>
                                                ...
                                                <a href="editar_contenido.php?id=<?php echo $row->ID; ?>"
                                                class="btn btn-info btn-sm"  title="EDITAR CONTENIDO"><i class="fa fa-pencil"></i></a>
                                            <?php
                                        }
                                        ?>
